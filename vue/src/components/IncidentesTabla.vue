                  ...
                  <div class="input-group w-50">
                   ...
                   <div class="d-flex justify-content-between">
                    <button v-show="!showFilters" class=" btn btn-primary mb-1"
                     ...
                     <button v-if="isAdmin" class="btn btn-primary border border-secondary ml-2" @click="openMantenimientoModal">
...
const createMantenimiento = async () => {
  if (!isAdmin.value) {
    console.error('Only administrators can create maintenance tasks');
    return;
  }
