<template>
              ...
              <ul v-else class="list-group list-group-flush">
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      <i :class="item.disabled ? 'bi-toggle-off' : 'bi-toggle-on'" class="bi"></i>
                    </button>
                ...
                >
                  ...
                  <div>
                    <button
                      ...
                      class="btn btn-sm btn-outline-secondary me-1"
                    >
                      <i :class="taller.disabled ? 'bi-toggle-off' : 'bi-toggle-on'" class="bi"></i>
                    </button>
                ...
                >
                  ...
                  <div>
                    <button
                      ...
                      class="btn btn-sm btn-outline-secondary me-1"
                    >
                      <i :class="tipoAveria.disabled ? 'bi-toggle-off' : 'bi-toggle-on'" class="bi"></i>
                    </button>
                ...
                >
                  ...
                  <div>
                    <button
                      ...
                      class="btn btn-sm btn-outline-secondary me-1"
                    >
                      <i :class="tipo.disabled ? 'bi-toggle-off' : 'bi-toggle-on'" class="bi"></i>
                    </button>
          ...
          <div class="modal-content custom-modal">
            <div class="modal-header custom-modal-header">
              <h5 class="modal-title text-dark" id="disableConfirmModalLabel">
                Confirmar
                {{ disablingItem && disablingItem.disabled ? 'Habilitación' : 'Deshabilitación' }}
              </h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              <p>
                ...
                {{ disablingItem && disablingItem.disabled ? 'habilitar' : 'deshabilitar' }} el item
  ...
  const confirmDisable = async () => {
      ...
      try {
          const itemId =
              disablingItem.value.id_tipo_averia ||
              disablingItem.value.id_tipo_mantenimiento ||
              disablingItem.value.id_campus ||
              disablingItem.value.id;
          await updateFunction(itemId, { disabled: !disablingItem.value.disabled });
          if (disableModalInstance) {
